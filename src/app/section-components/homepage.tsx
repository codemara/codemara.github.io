...
const Localcontent = (props: { localcontent: Array<ObjContent> }) => {
  ...
  for(let i in props.localcontent){
    //if (props.localcontent[i].type == 'p')
    console.log(props.localcontent[i].type)
  }
...
export default function Homepage(props: { zeSection: string }) {
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        >
          ...
          <svg x="50%" y={-1} className="overflow-visible fill-gray-50">
            <path
              //d="M168 289.573L332.411 193.159L496.822 289.573L496.822 477.926L332.001 574.341L168 477.928V289.573Z" 
